...
def array_stc(string,string2,vall,vall2):
...
print("")
print("Considering 10 Stocks of BSE")
array_stc("bsedata1.csv","10 Stocks of BSE",bse_mean,bse_var)

print("")
print("Considering 10 Stocks of NSE")
array_stc("nsedata1.csv","10 Stocks of NSE",nse_mean,nse_var)

print("")
print("Considering 10 Stocks not included in BSE")
array_stc("nse_non_index_data1.csv","10 Stocks not in BSE",bse_mean,bse_var)

print("")
print("Considering 10 Stocks not included in NSE")
array_stc("bse_non_index_data1.csv","10 Stocks not in NSE",nse_mean,nse_var)
